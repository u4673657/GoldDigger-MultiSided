...
public class Position {
	...
	public static final Fn1<Position, Position> NORTH = move
			.rightCurry(Position._NORTH);
	public static final Fn1<Position, Position> EAST = move
			.rightCurry(Position._EAST);
	public static final Fn1<Position, Position> SOUTH = move
			.rightCurry(Position._SOUTH);
	public static final Fn1<Position, Position> WEST = move
			.rightCurry(Position._WEST);

	public static final Fn1<Position, Position> NORTH_EAST = move
			.rightCurry(Position._NORTH_EAST);
	public static final Fn1<Position, Position> SOUTH_EAST = move
			.rightCurry(Position._SOUTH_EAST);
	public static final Fn1<Position, Position> NORTH_WEST = move
			.rightCurry(Position._NORTH_WEST);
	public static final Fn1<Position, Position> SOUTH_WEST = move
			.rightCurry(Position._SOUTH_WEST);
